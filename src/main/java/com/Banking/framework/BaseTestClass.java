...
import com.Banking.configures.Configures;
		...
		public void launchBrowser(Method method)
		{
			...
			case "FF":
				...
				case"CHROME":
					...
					System.setProperty("webdriver.chrome.driver", "C:\\Users\\hp\\eclipse-workspace\\Banking_Project\\Drivers\\chromedriver.exe");
